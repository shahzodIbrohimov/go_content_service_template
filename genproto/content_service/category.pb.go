...
func (x *Category) GetTitle() *MultiLanguage {
	if x != nil {
		return x.Title
	}
	return nil
...
func (x *Categories) GetItems() []*Category {
	if x != nil {
		return x.Items
	}
	return nil
...
var file_category_proto_rawDesc = []byte{
	...
	0xe6, 0x01, 0x0a, 0x08, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x28, 0x08, 0x52, 0x06, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x6c,
	...
	0x68, 0x6f, 0x74, 0x6f, 0x12, 0x14, 0x0a, 0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x18, 0x06, 0x20,
	...
	0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x53, 0x0a, 0x0a, 0x43, 0x61, 0x74, 0x65,
	...
	0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x42, 0x1a, 0x5a,
...
var file_category_proto_goTypes = []interface{}{
	(*Category)(nil),      // 0: content_service.Category
	(*Categories)(nil),    // 1: content_service.Categories
	(*MultiLanguage)(nil), // 2: content_service.MultiLanguage
}
var file_category_proto_depIdxs = []int32{
	2, // 0: content_service.Category.title:type_name -> content_service.MultiLanguage
	0, // 1: content_service.Categories.items:type_name -> content_service.Category
